...
import Projects from "@/assets/Projects(1)(1).png";
...
const ProjectsSection = () => {
    ...
    const projectImagePath = "/projects/Main/Projects(1)(1).png";
            ...
            >
                ...
                >
                    ...
                    <img
                        ...
                        className="relative z-10 max-w-none object-cover"
                        style={{
                            width: "clamp(25rem, 40vw, 56rem)",
                        }}
                    />
                </div>
